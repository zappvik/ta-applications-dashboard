...
export default function InstructionsBanner() {
  ...
  return (
    ...
    <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4 mb-6 rounded-r-md relative">
        ...
        <div className="ml-auto pl-3">
          ...
          <div className="-mx-1.5 -my-1.5">
            ...
            <button
              ...
              className="inline-flex rounded-md p-1.5 text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-900 focus:outline-none"
